...
import net.pattox.simpletransport.entity.ConveyorUpEntity;
import net.pattox.simpletransport.init.Conveyorbelts;
import org.jetbrains.annotations.Nullable;

@SuppressWarnings("deprecation")
public class ConveyorUp extends BlockWithEntity {
    public ConveyorUp(Settings settings) {
        super(settings);
    ...
    public BlockEntity createBlockEntity(BlockPos pos, BlockState state) {
        return new ConveyorUpEntity(pos, state);
    }
    ...
    public <T extends BlockEntity> BlockEntityTicker<T> getTicker(World world, BlockState state, BlockEntityType<T> type) {
        return checkType(type, Conveyorbelts.CONVEYOR_UP_ENTITY, ConveyorUpEntity::tick);
    }
