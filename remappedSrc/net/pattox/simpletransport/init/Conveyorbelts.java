package net.pattox.simpletransport.init;
...
public class Conveyorbelts {
    ...
    public static final Identifier CONVEYOR_IDENTIFIER = new Identifier(SimpleTransport.MOD_ID, "conveyor");
    public static final Block CONVEYOR = Registry.register(Registry.BLOCK, CONVEYOR_IDENTIFIER, new Conveyor(getBlockSettings(CONVEYOR_IDENTIFIER)));
    ...
    public static final Identifier CONVEYOR_DEMAG_IDENTIFIER = new Identifier(SimpleTransport.MOD_ID, "conveyor_demag");
    ...
    public static final Identifier EXTRACTOR_IDENTIFIER = new Identifier(SimpleTransport.MOD_ID, "extractor");
    ...
    public static final Identifier EXTRACTOR_UPPER_IDENTIFIER = new Identifier(SimpleTransport.MOD_ID, "extractor_upper");
    ...
    public static final Identifier CONVEYOR_DETECTOR_IDENTIFIER = new Identifier(SimpleTransport.MOD_ID, "conveyor_detector");

    public static final Block INSERTER;
    public static final BlockItem INSERTER_ITEM;
    public static final Identifier INSERTER_IDENTIFIER = new Identifier(SimpleTransport.MOD_ID, "inserter");

    public static final Block DESTRUCTOR;
    public static final BlockItem DESTRUCTOR_ITEM;
    public static final Identifier DESTRUCTOR_IDENTIFIER = new Identifier(SimpleTransport.MOD_ID, "destructor");
    ...
    public static final Identifier PULLER_IDENTIFIER = new Identifier(SimpleTransport.MOD_ID, "puller");
    ...
    public static final Identifier VACTRACTOR_IDENTIFIER = new Identifier(SimpleTransport.MOD_ID, "vactractor");
    ...
    public static final Identifier INSERTER_UPPER_IDENTIFIER = new Identifier(SimpleTransport.MOD_ID, "inserter_upper");
    ...
    public static final Identifier OPI_IDENTIFIER = new Identifier(SimpleTransport.MOD_ID, "opi");
    public static final ScreenHandlerType<GenericFilterScreenHandler> OPI_SCREEN_HANDLER;

    // Set the ItemGroup
    public static final ItemGroup ITEM_GROUP = FabricItemGroupBuilder.create(
                    new Identifier(SimpleTransport.MOD_ID, "general"))
            .icon(() -> new ItemStack(CONVEYOR))
            .build();

    static {
        //@TODO See if we can fix this sometimes
        ...
        CONVEYOR_DETECTOR_ITEM = Registry.register(Registry.ITEM, CONVEYOR_DETECTOR_IDENTIFIER, new BlockItem(CONVEYOR_DETECTOR, new FabricItemSettings().group(ITEM_GROUP)));
        ...
        EXTRACTOR_ITEM = Registry.register(Registry.ITEM, EXTRACTOR_IDENTIFIER, new BlockItem(EXTRACTOR, new FabricItemSettings().group(ITEM_GROUP)));
        ...
        EXTRACTOR_UPPER_ITEM = Registry.register(Registry.ITEM, EXTRACTOR_UPPER_IDENTIFIER, new BlockItem(EXTRACTOR_UPPER, new FabricItemSettings().group(ITEM_GROUP)));
        ...
        INSERTER_ITEM = Registry.register(Registry.ITEM, INSERTER_IDENTIFIER, new BlockItem(INSERTER, new FabricItemSettings().group(ITEM_GROUP)));

        DESTRUCTOR = Registry.register(Registry.BLOCK, DESTRUCTOR_IDENTIFIER, new Destructor(getBlockSettings(DESTRUCTOR_IDENTIFIER)));
        DESTRUCTOR_ITEM = Registry.register(Registry.ITEM, DESTRUCTOR_IDENTIFIER, new BlockItem(DESTRUCTOR, new FabricItemSettings().group(ITEM_GROUP)));

        PULLER = Registry.register(Registry.BLOCK, PULLER_IDENTIFIER, new Puller(getBlockSettings(PULLER_IDENTIFIER)));
        PULLER_ITEM = Registry.register(Registry.ITEM, PULLER_IDENTIFIER, new BlockItem(PULLER, new FabricItemSettings().group(ITEM_GROUP)));
        ...
        INSERTER_UPPER_ITEM = Registry.register(Registry.ITEM, INSERTER_UPPER_IDENTIFIER, new BlockItem(INSERTER_UPPER, new FabricItemSettings().group(ITEM_GROUP)));
        ...
        OPI_ITEM = Registry.register(Registry.ITEM, OPI_IDENTIFIER, new BlockItem(OPI, new FabricItemSettings().group(ITEM_GROUP)));
        ...
        VACTRACTOR_ITEM = Registry.register(Registry.ITEM, VACTRACTOR_IDENTIFIER, new BlockItem(VACTRACTOR, new FabricItemSettings().group(ITEM_GROUP)));
